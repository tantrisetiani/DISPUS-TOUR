                    ...
                    <tbody>
                        ...
                        <?php foreach ($admin as $admin) : ?>
                            <tr class="text-center">
                                ...
                                <td>
                                    <img src="<?php echo base_url(); ?>assets/img/admin/<?= $admin['foto_admin']; ?>" width="100" height="100">
                                </td>
                                <td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Apakah Anda yakin ingin menghapus Data Admin?</h5>
